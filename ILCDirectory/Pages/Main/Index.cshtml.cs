...
namespace ILCDirectory.Pages.Main
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task OnGetAsync()
        {
            ...
            (Persons, HouseholdAddresses) = await SearchAsync(LocalSearch, IncludeChildren, SearchPartialWords, SearchText);
        }
        ...
        private async Task<(IList<Person>, IList<HouseholdAddress>)> SearchAsync(bool localSearch, bool includeChildren, bool searchPartialWords, string searchText)
        {
            (var persons, var householdAddresses) = await _searchRepo.SearchForPersonOrAddress(_cfg, searchText, searchPartialWords, includeChildren, localSearch);
